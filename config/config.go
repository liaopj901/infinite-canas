...
type Config struct {
	...
	GeneratedMediaDir           string `env:"GENERATED_MEDIA_DIR" envDefault:"data/generated-images"`
	GeneratedMediaRetentionDays int    `env:"GENERATED_MEDIA_RETENTION_DAYS" envDefault:"7"`
}
